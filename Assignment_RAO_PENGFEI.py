...
# adjusting the font size of the ticks in x and y axis
...
print('Printing the head of the data about administrator...')
print(admin.head())
# answer the question about mean and standard variance
print(f'\nThe mean age of administrator:{admin.age.mean()}')
print(f'The standard deviation age of administrator:{admin.age.std()}\n\n')

# ================ Entering Part B =======================
print('Now entering Part B...\n')
# ========================== Q1 ========================== 
print('Entering Q1...\nNow plotting the trajectory of the particle...\n')
# time series
...
plt.title('The trajectory of the particle',fontsize = 30)
